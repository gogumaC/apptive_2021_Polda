...
public abstract class Sticker {
  ...
  public float[] unrotatedWrapperCorner(){
    return unrotatedWrapperCorner;
  }
  public float[] unrotatedPoint(){
    return unrotatedPoint;
  }
  public float[] boundPoints(){
    return boundPoints;
  }
  public float[] mappedBounds(){
    return mappedBounds;
  }


  /*StickerData(var matrixValues:Array<String>,var unrotatedWrapperCorner:Array<String>,
                       var unrotatedPoint:Array<String>,var boundPoints:Array<String>
                       ,var mappedBounds:Array<String>,var isFlipHorizontally:Boolean)*/
  ...
  @NonNull public Matrix getMatrix() {
    //Log.d("matrix","getMatrix "+matrix.toString());
    return matrix;
  }

  public Sticker setMatrix(@Nullable Matrix matrix) {
    Log.d("matrix","setMatrix"+matrix.toString());
