...
import com.apptive.android.polda.AdapterStickerList
import com.apptive.android.polda.AdapterStickerViewPager
import com.apptive.android.polda.R
import com.apptive.android.polda.StickerListFromAsset
    ...
    : LinearLayout(context,attrs,defStyleAttr)
{
    ...
    init{
        ...
        val icons=arrayOf<Int>(R.drawable.polygon,R.drawable.star,
            R.drawable.union,R.drawable.sticker_tab_ellipse,R.drawable.diamond)
